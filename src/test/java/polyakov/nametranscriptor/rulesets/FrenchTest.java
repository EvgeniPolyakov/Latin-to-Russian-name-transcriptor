...
class FrenchTest {
    ...
    void transcribe() {
        String text = """
                lauraët liart cognac bayard chaillac troyat caen nationale d aéronautique air france calais saint \
                nazaire épiais raspail chénérailles ain aincourt aingoulaincourt saintes paramé ham pamfou \
                ...
                troyes oyeu pierre philippe quinet jacques renoir roger eymoutiers serrault perrault serge guendouzi \
                ...
                villedubert villejuif villers villey le sec villerville villette anthon villez xanrey xavier \
                xaronval auxerre villeurbane yeuse hyevr pleyel yves alyn jamyn vierzon mawlaz yassine""";
        String transcription = """
                лораэ льяр коньяк байар шайак труайа кан насьональ д аэронотик эр франс кале сен назер эпье распай \
                шенерай эн энкур энгуленкур сен параме ам панфу данвиль тан л этап арто клод эме дю белле брюлье \
                лайон паи де бре бато лавуар камю франсис мон блан фран марк леклер безансон аккор оксиданталь кристиан \
                ош бук аспе де ла гуно ришар ангулем шарль жак вильдье эдмон уэст рене ришелье экоммуа эно жиль \
                ...
                жак ренуар рожер эмутье серро перро серж гендузи алексис жорес фура калла каю лавуазье жак тур со \
                скапен буссенар шерер руссо брессон доде гонкур чеки чаволо либерасьон жансью лембр люнан юненг \
                оргейль брюннен энверр меэн эндлен шатоден бельзенс лебрен виктор верлен гвенаэль ватто бовиль \
                вильдюбер вильжюиф виллер вилле ле сек виллервиль виллетт антон вилле ксанре ксавье ксаронваль осер \
                виллербан йез йевр плейель ив ален жамен вьерзон мавлаз яссин""";
