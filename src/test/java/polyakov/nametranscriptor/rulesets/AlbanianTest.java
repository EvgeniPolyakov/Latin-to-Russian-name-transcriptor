...
class AlbanianTest {
    ...
    void transcribe() {
        String text = """
                ...
                bebeziqi rejan alivoda cipi redon dragoshi kumbulla rezart halili enes isufi kalaj erald lakti livio \
                ...
                kalaja kostaj mucellari kejsi saliaj""";
        String transcription = """
                ...
                халили энес исуфи каляй эральд лякти ливио маляй пьетри алиа юрген цельхака кристиан фрроку марсель \
                ...
                ррагами армеля герги леши ризаларай каляя костай муцелари кейси салиай""";
