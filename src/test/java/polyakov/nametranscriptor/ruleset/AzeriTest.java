...
class AzeriTest {
    ...
    void transcribe() {
        String text = """
                ...
                fatima ahmadli fidan zahir jafarova lamia alizada leyla aghayeva milana rahimova nahida nurchin \
                tarverdizada parvin safaraliyeva samira ashırova turkan abdullayeva zuleykha zamanlı arzu aliyeva \
                aygun gurbanzade diana mammadova esra manya firangiz teymurova gultaj mammadaliyeva gunay kristina \
        ...
        String transcription = """
                ...
                рзаев вусал аскеров замиг алиев алина айсун мурадова айтадж фейзуллаева фатима ахмедли фидан захир \
                ...
                манья фирангиз теймурова гюльтадж мамедалиева гунай кристина бакарандзе лейли гурбанова мана моллаева \
