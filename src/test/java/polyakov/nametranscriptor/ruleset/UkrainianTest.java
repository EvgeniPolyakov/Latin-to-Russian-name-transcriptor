...
import polyakov.nametranscriptor.ruleset.rulsets.Ukrainian;
...
class UkrainianTest {
    ...
    void transcribe() {
        ...
        String transcription = """
                алушта андрей борщагивка борисенко винниця владимир богдан згурский галаган горгани донецк дмитрий \
                ...
                онищенко полтава петр решетиливка рибчинский суми соломия тернопил троц ульяна фастив филипчук харкив \
