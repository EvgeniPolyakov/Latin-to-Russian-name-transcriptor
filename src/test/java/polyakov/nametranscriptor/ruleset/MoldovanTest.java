...
import polyakov.nametranscriptor.ruleset.rulsets.Moldovan;
...
class MoldovanTest {
    ...
    void transcribe() {
        ...
        String transcription = """
                ...
                мурованый корнеенков андронаки репинецкий нагорный казаку корнелий цыбуляк гуржуй йонуц чобану жупанова \
                чумаченко ожеховский кучерявый евгений зэмостяну житарюк виктория выктэрэу дижинарь андрей маковийчук \
                анатолий аурел кэтэлин константин дмитрий эуджения евгений эрик эдуард эдвард евгений евгения евгений \
                геннадий георге янина ярослав юрий игорь ливиу людмила марчела михай михаил надежда наталия николай \
                николай олеся ольга руслан семен сергей сергей сергей сергей татьяна валерий валерий василий вячеслав \
