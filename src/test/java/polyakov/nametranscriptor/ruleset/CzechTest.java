...
import polyakov.nametranscriptor.ruleset.rulsets.Czech;
...
class CzechTest {
    ...
    void transcribe() {
        String text = """
                ...
                dobroslav bedřich svitava netoušek mathesius thůnová baťha ulehlová ťopan vitězslav \
        ...
        String transcription = """
                ...
                крейчий долейший балайка ондржей янечек своянов кавульяк елинкова йирак зайиц льикар кушльич йовса \
                киев алье юза гавел богумил палкоскова луцкий костронь водняны нетоушек тепан доброслав бедржих \
                свитава нетоушек матесиус тунова батьга улеглова тепан витезслав вебер ксаверова млыняны гейровский \
                рыбак подебрады тршеблицкий козуский зрзавы важны юза жижка хилкова гикеш анета фойтикова петра \
                ...
                урича вагнер вехета мартин витик патрик выдра денис вишинский маттео бурго михал чернак мартин зентрих""";
