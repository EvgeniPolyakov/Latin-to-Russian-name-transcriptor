...
class BulgarianTest {
    ...
    void transcribe() {
        String text = """
                ...
                silvia dzhaleva ekaterina elena""";
        String transcription = """
                ...
                атанасов петар кристиян кацарев димитар велковский наско милев живко хаджиев красимир владимир \
                ...
                виктория габриела найденова белева илийчева палагачева сильвия джалева екатерина елена""";
