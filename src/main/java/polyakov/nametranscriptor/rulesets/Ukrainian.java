...
import polyakov.nametranscriptor.rulesets.names.UkrainianNames;

import java.util.Arrays;
import java.util.Map;
import java.util.Optional;

import static polyakov.nametranscriptor.rulesets.customrules.Ukrainian.ENDINGS;
import static polyakov.nametranscriptor.rulesets.customrules.Ukrainian.STARTERS;
