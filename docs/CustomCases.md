...
* транскриптор не различает случаи "s" между гласными на стыке слов, которые должны передаваться как "с" (вместо "з").
* транскриптор не различает разные случаи трактовки частицы "ss" между гласными, транскрибируя её как одинарную "с".
* транскриптор следует современной норме передачи "l" как твердой "л", но ставит традиционную мягкую "ль" в конце слов.
* на фоне разночтений в источниках транскриптор транскрибирует частицу "jü" как "ю".
